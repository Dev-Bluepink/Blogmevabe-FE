          ...
          children:
            ...
            e.jsx("div", {
              className: `flex-1 m-2.5 bg-white rounded-md ${
                !t && "flex justify-center items-center"
              }`,
...
function g({ message: t, toUser: l, messageIndex: a }) {
  ...
  return e.jsxs(p.li, {
    ...
    className: ` pl-2 py-1 w-fit rounded-md ${
      t.seen ? "bg-green-100" : "bg-blue-100"
    } ${l ? "ml-auto pr-2" : "pr-10"}`,
    children: [
      e.jsx("p", {
