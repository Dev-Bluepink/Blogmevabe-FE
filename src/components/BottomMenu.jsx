      ...
      <div className="flex justify-around p-2 border-t border-[#E5E5E5]">
        ...
        >
          ...
          >
            <g clipPath="url(#clip0_336_777)" fillRule="evenodd">
              <path
                ...
                fill={active === "home" ? "#7AC0F8" : "#494949"}
              />
            </g>
            <defs>
          ...
          <span
            ...
            className={`text-xs ${
              active === "home" ? "text-[#7AC0F8]" : "text-[#494949]"
            }`}
          >
            Trang chủ
          </span>
        ...
        >
          ...
          >
            <path
              ...
              fill={active === "region" ? "#7AC0F8" : "#494949"}
            />
          </svg>
          <span
            className={`text-xs ${
              active === "region" ? "text-[#7AC0F8]" : "text-[#494949]"
            }`}
          >
            Khu vực
          </span>
        ...
        >
          ...
          >
            <g clipPath="url(#clip0_2_96)">
              <path
                ...
                fill={active === "notification" ? "#7AC0F8" : "#494949"}
              />
              <path
          ...
          <span
            className={`text-xs ${
              active === "notification" ? "text-[#7AC0F8]" : "text-[#494949]"
            }`}
          >
            Thông báo
          </span>
        ...
        <a
          href="/u/knowledge"
          className={`flex flex-col items-center ${
            active === "knowledge" ? "text-[#7AC0F8]" : "text-[#494949]"
          }`}
        ...
        >
          ...
          >
            <path
              ...
              fill={active === "knowledge" ? "#7AC0F8" : "#494949"}
            />
          </svg>
